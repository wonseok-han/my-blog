...
thumbnail: '/thumbnail/blog-posts/11-설치형(Self-hosted)-Gitlab-환경에서-Vercel-배포하기.png'
category: 'DevOps'
...
![failed-ci](/images/blog-posts/11-설치형(Self-hosted)-Gitlab-환경에서-Vercel-배포하기/failed-ci.png)
