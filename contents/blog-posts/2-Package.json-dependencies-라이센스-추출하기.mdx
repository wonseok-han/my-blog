...
thumbnail: '/thumbnail/blog-posts/2-Package.json-dependencies-라이센스-추출하기.png'
category: 'Development'
tags: ['NPM', 'Package.json', 'License', 'Dependencies', 'License Checker', 'Node.js', 'Open Source', 'Legal', 'Compliance']
---
