...
thumbnail: '/thumbnail/blog-posts/9-PWA가-뭔지-알아보고-직접-만들어보자.svg'
category: 'Frontend'
tags: ['PWA', 'Next.js', 'Firebase', 'Service Worker', 'Web App', 'Progressive Web App', 'next-pwa']
---
...
![localhost-pwa](/images/blog-posts/9-PWA가-뭔지-알아보고-직접-만들어보자/localhost-pwa.png)

<br />

![install-pwa](/images/blog-posts/9-PWA가-뭔지-알아보고-직접-만들어보자/install-pwa.png)

![install-pwa-attribute](/images/blog-posts/9-PWA가-뭔지-알아보고-직접-만들어보자/install-pwa-attribute.png)

<br />

설치된 앱을 실행하면 다음과 같이 PWA가 적용된 내 블로그를 확인할 수 있다.

![execute-pwa](/images/blog-posts/9-PWA가-뭔지-알아보고-직접-만들어보자/execute-pwa.png)
...
![lighthouse](/images/blog-posts/9-PWA가-뭔지-알아보고-직접-만들어보자/lighthouse.png)
...
![lighthouse-result](/images/blog-posts/9-PWA가-뭔지-알아보고-직접-만들어보자/lighthouse-result.png)
...
![lighthouse-fix](/images/blog-posts/9-PWA가-뭔지-알아보고-직접-만들어보자/lighthouse-fix.png)
