...
thumbnail: '/thumbnail/blog-posts/8-jest를-적용해서-테스트-코드를-작성해보자.png'
category: 'Frontend'
tags: ['Testing', 'Next.js', 'Jest', 'React Testing Library', 'Unit Test', 'TDD', 'Test Setup', 'JSDOM']
---
...
![jest-init](/images/blog-posts/8-jest를-적용해서-테스트-코드를-작성해보자/jest-init.png)

<br />

호기롭게 "좋았어! package.json에 jest로 test 명령도 추가됬겠다 한 번 돌려보자!" 하고 돌렸더니 터졌다.

![ts-node-error](/images/blog-posts/8-jest를-적용해서-테스트-코드를-작성해보자/ts-node-error.png)
...
![jest-init-test](/images/blog-posts/8-jest를-적용해서-테스트-코드를-작성해보자/jest-init-test.png)
...
![test-result](/images/blog-posts/8-jest를-적용해서-테스트-코드를-작성해보자/test-result.png)
